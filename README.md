...
This will take little time to download and install base packages. <br />

#### Step 14: Now after getting cmd prompt. you have to generate fstab file. <br />
...
note : if you find any steps confusing or want to contribute or have any feed back 
contact me via 
```email : geeknzoy.protonmail.com```
```discord : https://discord.gg/UkbVeqF3aE``` (server)
